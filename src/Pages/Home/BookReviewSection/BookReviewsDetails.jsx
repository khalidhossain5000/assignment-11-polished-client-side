        ...
        <div className="py-12 lg:py-24 bg-light-background ">
              ...
              <div className="container mx-auto py-24 lg:flex justify-center gap-12 shadow-xl shadow-light-secondary border-1 border-light-secondary rounded-md">
                <div className="imgs rounded-sm p-5 !h-full border-1 border-light-primary">
                  <img className="hover:scale-105 hover:saturate-150 cursor-pointer transition duration-300 lg:w-96 mx-auto w-56" src={books?.imageUrl} alt="" />
                </div>
        
                <div className="contnt w-full space-y-2">
                  <h1 className="font-secondary text-light-text text-sm md:text-xl lg:text-3xl font-bold">Book Name: {books?.title}</h1>
                  <h2 className="font-secondary text-light-text text-sm md:text-xl font-bold">
                    By : <span className="text-light-primary font-extrabold font-primary">{books?.author}</span>
                  </h2>
                  <h2 className="font-secondary text-light-text text-sm md:text-xl font-semibold">
                    Category : <span className="text-light-primary font-primary font-extrabold">{books?.category}</span>
                  </h2>
                  ...
                  <p className="py-2 md:py-4 font-secondary text-light-text text-sm lg:text-xl ">
                    <span className="font-secondary text-light-text text-sm md:text-xl lg:text-2xl font-bold">Review Details:</span> : {books?.description}
                  </p>
