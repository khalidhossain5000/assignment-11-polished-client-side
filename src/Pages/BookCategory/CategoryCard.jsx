      ...
      <div className="text-center py-3 lg:py-6 mt-auto rtign space-y-6 lg:space-y-12">
        ...
        {user?.email && (
          <Link to={`/all-books/${_id}`}>
            <button className="bg-light-primary px-3 py-4 md:px-9 md:py-4 rounded-sm font-primary font-semibold font-light-text text-md lg:text-xl hover:scale-110 hover:shadow-xl hover:shadow-light-secondary transition duration-300 cursor-pointer text-light-text">
              View Details
            </button>
          </Link>
        )}
